      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="../../../home.php"><img src="../../../masterPage/assets/img/ecompjr.png " width="120" height="40"></a>
          </div>
            ...
            <ul class="navbar-nav ml-auto">
              <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu dropdown-navbar">
                  ...
                  <li class="nav-link"><a href="../../../home.php" class="nav-item dropdown-item">Log out</a></li>
                </ul>
              </li>
          ...
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-fill btn-primary">Confirmar</button>
              </div>
            </div>
          </div>
      <footer class="footer">
